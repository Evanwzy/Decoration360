...
- (void)dealloc
{
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"POPCONTROLLER" object:nil];
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"POPTOROOTCONTROLLER" object:nil];
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"PRESENTCONTROLLER" object:nil];
